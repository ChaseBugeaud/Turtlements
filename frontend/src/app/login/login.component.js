...
var LoginComponent = function () {
    ...
    var LoginComponent = _classThis = /** @class */ (function () {
        function LoginComponent_1() {
            this.username = "";
            this.password = "";
            this.loginService = (0, core_2.inject)(login_service_1.LoginService);
        }
        //API URL here for endpoint?
        //localhost:3000/tournament/create
        ...
        LoginComponent_1.prototype.onSubmit = function () {
            ...
            //return credentials;
            this.loginService.login(credentials).subscribe(function (response) {
